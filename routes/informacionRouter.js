...
const { getAllEstadoProcesoHandler, getAllGeneroAgresorHandler, getAllGeneroVictimaHandler, getAllSeveridadProcesosHandler } = require('../handlers/InformacionAgresionHandler');
