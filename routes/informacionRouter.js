...
const { getAllEstadoProcesoHandler,getAllSeveridadesHandler, getAllGeneroAgresorHandler, getAllGeneroVictimaHandler, getAllSeveridadProcesosHandler } = require('../handlers/InformacionAgresionHandler');
